...
import com.ensimtest.module.settings.ConfigurationList;
import com.ensimtest.module.settings.ConfigurationType;
...
public class CopyOfOrgCreateTestCases 
{
	...
	public CopyOfOrgCreateTestCases()
	{
	...
	{
		ConfigurationList option = new ConfigurationList();
		option.getConfigurationOptionLnk(ConfigurationType.Usage_Import).click();
